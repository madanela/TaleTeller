...
var playlist = [
	{
		...
		"album"   : "Fairy tale",
		"artist"  : "TaleTeller",
		"artwork" : "static/tale4.png",
		"wav"     : "static/test2.wav"
	}
];
...
function load(){
	...
	music.innerHTML = '<source src="'+audio_path+'" type="audio/wav">';
	music.load();
}
function reset(){ 
	...
	artist.title = playlist[currentSong]['artist'];
	artwork.setAttribute("style", "background:url(https://i.imgur.com/3idGgyU.png), url('"+playlist[currentSong]['artwork']+"') center no-repeat;");
	music.innerHTML = '<source src="'+playlist[currentSong]['wav']+'" type="audio/wav">';
	music.load();
}
